...
export default function ResultReveal({
    ...
    const [displayActual, setDisplayActual] =
        useState(actual);
    ...
    const tier = useMemo<RevealTier>(() => {
        ...
        if (normalizedError <= 0.1) {
            return {
                ...
                glowColor:
                    "drop-shadow-[0_0_20px_rgba(74,222,128,0.85)]",
                backgroundColor:
                    "bg-green-400/15",
                ringColor:
                    "border-green-400/50",
        ...
        if (normalizedError <= 0.2) {
            return {
                ...
                glowColor:
                    "drop-shadow-[0_0_18px_rgba(34,211,238,0.75)]",
                backgroundColor:
                    "bg-cyan-400/12",
                ringColor:
                    "border-cyan-400/45",
        ...
        if (normalizedError <= 0.3) {
            return {
                ...
                glowColor:
                    "drop-shadow-[0_0_16px_rgba(251,146,60,0.7)]",
                backgroundColor:
                    "bg-orange-400/10",
                ringColor:
        ...
        if (normalizedError <= 0.5) {
            return {
                ...
                glowColor:
                    "drop-shadow-[0_0_10px_rgba(253,186,116,0.4)]",
                backgroundColor:
                    "bg-orange-300/5",
                ringColor:
    ...
    const formattedError =
        normalizedError < 0.005
            ? "0.00"
            : normalizedError.toFixed(2);
        ...
        <>
            ...
            >
                ...
                {(tier.animation === "perfect" ||
                    ...
                    "bullseye") &&
                    showRating && (
                        <div className="result-rays pointer-events-none absolute left-1/2 top-1/2 -z-10 h-72 w-72 -translate-x-1/2 -translate-y-1/2">
                            {Array.from({
                                length: 12,
                            }).map((_, index) => (
                                <span
                ...
                <div className="relative z-10 w-full">
                    ...
                    <div
                        ...
                        `}
                    >
                        <p className="text-[9px] font-bold uppercase tracking-[0.35em] text-zinc-600">
                            Total Error
                        </p>
                        ...
                        {tier.animation ===
                            "perfect" && (
                                <div className="mb-2 flex items-center justify-center gap-2">
                                    <span className="h-px w-10 bg-gradient-to-r from-transparent to-yellow-300" />
                                    <span className="result-perfect-star text-xl text-yellow-300">
                                        ✦
                                    </span>
                                    <span className="h-px w-10 bg-gradient-to-l from-transparent to-yellow-300" />
                                </div>
                            )}
            ...
            <style jsx>{`
                ...
                .result-excellent-time {
                    animation: excellentTime
                        550ms ease-out both;
                }

                .result-great-time {
                    animation: greatTime 500ms
                        ease-out both;
                }

                .result-close-time {
                    animation: closeTime 430ms
                        ease-out both;
                }

                .result-decent-time {
                    animation: decentTime 350ms
                        ease-out both;
                }

                .result-miss-time {
                    animation: missTime 280ms
                        ease-out both;
                }

                .result-perfect-rating {
                    animation: perfectRating 850ms
                        cubic-bezier(
                            0.16,
                            1.4,
                            0.3,
                ...
                .result-excellent-rating {
                    animation: excellentRating
                        500ms ease-out both;
                }

                .result-great-rating {
                    animation: greatRating 450ms
                        ease-out both;
                }

                .result-close-rating {
                    animation: closeRating 400ms
                        ease-out both;
                }

                .result-decent-rating {
                    animation: decentRating 320ms
                        ease-out both;
                }

                .result-miss-rating {
                    animation: missRating 260ms
                        ease-out both;
                }

                .result-perfect-flash {
                    animation: perfectFlash 700ms
                        ease-out both;
                }

                .result-ring-one {
                    animation: ringExpand 900ms
                        ease-out both;
                }
                ...
                .result-rays {
                    animation: raysReveal 850ms
                        ease-out both;
                }

                .result-particle {
                    animation: particleBurst 850ms
                        cubic-bezier(
                            0.15,
                            0.75,
                            0.25,
